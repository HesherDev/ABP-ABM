...
public abstract class ABMWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static ABMWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(ABMWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<ABMDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<ABMDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<ABMDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<ABMDbContext, Task<T>> func)
    {
        T result;
