...
namespace ABM.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly ABMDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = ABMConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(ABMDbContext context)
    {
        _context = context;
    }
